...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  planMode: 'plan.md',
  principalProvider: 'web-server.md',
  principals: 'web-server.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AuthenticatedPrincipalContext: 'web-server.md',
  PrincipalRequest: 'web-server.md',
  PrincipalResponse: 'web-server.md',
