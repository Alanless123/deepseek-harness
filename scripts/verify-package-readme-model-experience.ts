...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/identity/principal': { kind: 'none', reason: 'Host-only authentication context; it registers no prompt, tool, event, or model-visible text.' },
  'packages/identity/principal-oidc': { kind: 'none', reason: 'Host-only identity provider; protocol material and Principal claims never enter model-visible state.' },
